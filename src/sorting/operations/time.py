...
from src.sorting.operations.math import get_random_list
...
def get_sorting_data(samples):
    ...
    return [
        take_median_time_for_algorithm(samples, heapSort()),
        take_median_time_for_algorithm(samples, mergeSort()),
        take_median_time_for_algorithm(samples, quickSort()),
